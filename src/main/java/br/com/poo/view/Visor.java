...
public class Visor extends JPanel {
    ...
    private void inicializarComponentes() {
        ...
        adicionarLabel("Nome:", 16, new Rectangle(20, 190, 100, 20));
        adicionarLabel("Vôlei", 16, new Rectangle(100, 190, 200, 20));
        adicionarLabel("Partido:", 16, new Rectangle(20, 220, 100, 20));
        adicionarLabel("PEsp", 16, new Rectangle(100, 220, 100, 20));
        adicionarLabel("Vice-Governador:", 16, new Rectangle(20, 250, 160, 20));
        adicionarLabel("Tênis", 16, new Rectangle(170, 250, 200, 20));
        adicionarLabel("Governador", 12, new Rectangle(585, 190, 100, 20));
        adicionarLabel("Vice-Governador", 12, new Rectangle(568, 360, 120, 20));
        ...
        adicionarLabel(
            ...
            15, new Rectangle(20, 285, 500, 100)
        );
    ...
    private void redimensionarComponentes() {
        ...
        for (JComponent comp : componentes) {
            ...
            Font fonteAntiga = comp.getFont();
            float novoTamanho = (float) (fonteAntiga.getSize2D() * Math.min(escalaX, escalaY));
            comp.setFont(fonteAntiga.deriveFont(novoTamanho));
        }
